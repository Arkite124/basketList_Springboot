...
INSERT INTO "product" ("product_category", "product_name", "product_img_url", "product_description", "product_price", "product_user_no", "product_quantity")
VALUES ('alcohols', '호로요이', 'image/alcohols/horoyoi.jpg', '술 잘 못하는 분도 쉽게 마실수 있는 산토리니 호로요이!', 4500, 2, 85);
...
INSERT INTO "product" ("product_category", "product_name", "product_img_url", "product_description", "product_price", "product_user_no", "product_quantity")
VALUES ('instantFood', '시래기된장국(3개입)', 'image/instantFood/doenjangguk.jpg', '사골국물로 맛을 낸 /n 전통 시래기 된장국 맛을 느껴보세요.', 15900, 2, 120);
...
VALUES (21, 3, 3, SYSDATE);

INSERT INTO "cartItemList" ("product_no", "list_user_no", "quantity", "added_at")
VALUES (16, 5, 2, SYSDATE);

INSERT INTO "cartItemList" ("product_no", "list_user_no", "quantity", "added_at")
VALUES (33, 8, 2, SYSDATE);

INSERT INTO "cartItemList" ("product_no", "list_user_no", "quantity", "added_at")
VALUES (25, 6, 2, SYSDATE);

INSERT INTO "cartItemList" ("product_no", "list_user_no", "quantity", "added_at")
VALUES (37, 9, 2, SYSDATE);
commit;
